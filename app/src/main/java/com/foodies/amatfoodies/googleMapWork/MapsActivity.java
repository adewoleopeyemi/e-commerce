...
import com.foodies.amatfoodies.activitiesAndFragments.PagerMainActivity;
...
public class MapsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getApplicationContext().getSharedPreferences(PreferenceClass.user, MODE_PRIVATE);
